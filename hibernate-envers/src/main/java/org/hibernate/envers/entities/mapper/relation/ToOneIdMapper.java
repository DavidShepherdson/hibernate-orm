...
public class ToOneIdMapper extends AbstractToOneMapper {
    ...
    public boolean mapToMapFromEntity(SessionImplementor session, Map<String, Object> data, Object newObj, Object oldObj) {
        ...
        /**
         * This method has been patched to use newObj for nonInsertableFake when oldObj is null.
         * See CDM-10199.
         */
        Object sourceObj = newObj;
        if (nonInsertableFake && oldObj != null)
        {
            sourceObj = oldObj;
        }
        delegate.mapToMapFromEntity(newData, sourceObj);
